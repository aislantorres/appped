...
},beforePageText:"Pagina",afterPageText:"de {pages}",displayMsg:"Exibindo {from} ate {to} de {total} itens",nav:{first:{iconCls:"pagination-first",handler:function(){
...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,interval:200,missingMessage:"Campo obrigatorio.",invalidMessage:null,tipPosition:"right",deltaX:0,deltaY:0,novalidate:false,editable:true,disabled:false,readonly:false,validateOnCreate:true,validateOnBlur:false,events:{focus:_4be,blur:_4c2,mouseenter:_4c5,mouseleave:_4c8,click:function(e){
var t=$(e.data.target);
...
},message:"E-mail invalido, digite um e-mail valido."},url:{validator:function(_4ed){
...
},message:"Digite um valor entre {0} e {1}."},remote:{validator:function(_4f0,_4f1){
var data={};
data[_4f1[1]]=_4f0;
var _4f2=$.ajax({url:_4f1[0],dataType:"json",data:data,async:false,cache:false,type:"post"}).responseText;
return _4f2=="true";
},message:"Por favor, corrija este campo."}},onBeforeValidate:function(){
...
$.fn.calendar.defaults={width:180,height:180,fit:false,border:true,showWeek:false,firstDay:0,weeks:["D","S","T","Q","Q","S","S"],months:["Jan","Fev","Mar","Abr","Mai","Jun","Jul","Ago","Sep","Out","Nov","Dez"],year:new Date().getFullYear(),month:new Date().getMonth()+1,current:(function(){
var d=new Date();
...
_b94(this,q);
}},currentText:"Hoje",closeText:"Fechar",okText:"Ok",buttons:[{text:function(_ba9){
